...
INSERT OR IGNORE INTO categories(id,slug,name,description,library_scope,sort_order) VALUES
 ...
 ('cat_answer','dap-an-rubric','Đáp án & Rubric','Đáp án, thang điểm và tiêu chí đánh giá.','sfn',40),
 ...
 ('cat_topic','chuyen-de','Chuyên đề','Chuyên đề học thuật do SFN biên soạn.','sfn',70),
 ...
 ('cat_links','thu-vien-lien-ket','Thư viện liên kết','Danh mục liên kết học thuật.','external',140);
